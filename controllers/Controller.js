  ...
  static async handleRequest(request, response, serviceOperation) {
    try {
      ...
      if (request.headers.authorization !== undefined) {
        const dataFromToken = getDataFromTokenIfValid(request.headers.authorization)
        serviceResponse = await serviceOperation(this.collectRequestParams(request), dataFromToken);
      } else {
...
const getDataFromTokenIfValid = (token) => {
  try {
